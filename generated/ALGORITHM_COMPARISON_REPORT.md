...
| **生成時間** | ~2秒 | ~5秒 | N/A |
| **主要用途** | プロトタイピング | 構造検証 | N/A |

**注**: ペアワイズはISO Schemaの規模が大きく（推定500個以上のオプション項目）、実行時間の制約により未実施。
...
*大規模スキーマではペアワイズの実行時間が長くなる可能性あり（5分以上）
...
| テストデータ | ペアワイズ** | 推定40〜60ファイル |
| プロトタイピング | 貪欲法 | 55〜65%, 2〜3秒 |

**超大規模スキーマではペアワイズの実行時間が非常に長くなる可能性あり（タイムアウト注意）
